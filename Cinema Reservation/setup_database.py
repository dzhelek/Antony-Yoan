...
from queries import create_user_table, create_movie_table, insert_initial_movies_in_movie_table, create_projection_table, insert_initial_projections_in_projection_table, create_reservation_table, insert_initial_user_in_user_table, insert_initial_reservations_in_reservation_table
